...
/**
 * A class containing MyFileHandler
 * version 1.0
 */
public class MyFileHandler
{
  /**
   * This method writes a string to a file with the given file name
   *
   * @param fileName
   * @param str
  ...
  /**
   * This method adds the given String to a file with a given file name
   *
   * @param fileName
   * @param str
   * @throws FileNotFoundException
  ...
  /**
   * writeToTextFile and appendToTextFile are almost the same - only the boolean in the constructor
   * of the FileOutputStream differs.
   *
   * @param fileName
   * @param str
   * @param append
  ...
  /**
   * This method writes the strings in the given array to a file with a given file name
   *
   * @param fileName
   * @param strs
   * @throws FileNotFoundException
  ...
  /**
   * This adds the strings in the  given array to a file with the given file name
   *
   * @param fileName
   * @param strs
   * @throws FileNotFoundException
  ...
  /**
   * This method is similar to writeArrayToTextFile and appendArrayToTextFile methods are almost identical
   * both methods call this private method
   *
   * @param fileName
   * @param strs
   * @param append
  ...
  /**
   * This method first line from the file with the given file name and returns it as a String
   *
   * @param fileName
   * @return
   * @throws FileNotFoundException
  ...
  /**
   * These methods Reads all lines from the file with the given file name and returns it as a String[]
   *
   * @param fileName
   * @return
   * @throws FileNotFoundException
  ...
  /**
   * This method writes the given object to a file with the given file name
   *
   * @param fileName
   * @param obj
   * @throws FileNotFoundException
  ...
  /**
   * This method writes the objects in the given array to a file with the given file name
   *
   * @param fileName
   * @param objs
   * @throws FileNotFoundException
  ...
  /**
   * This method reads the first object from the file with the given file name and returns it.
  ...
  /**
   * This method reads all objects from the file with the given file name and returns it as an Object[].
